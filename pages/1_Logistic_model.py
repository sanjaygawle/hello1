...
# ==================================================================
def ty(url):
     st.markdown(f'<marquee><p style="background-color:	#f2f3f4;color:#4b5320;font-size:24px;border-radius:2%;text-align:center">{url}</p></marquee>', unsafe_allow_html=True)
